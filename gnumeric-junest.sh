...
LIBSAVED="libuuid libp11-kit libidn libtasn libhogweed libresolv libgtk- $lib_browser_launcher" # Enter here keywords or file/directory names to save in /usr/lib
